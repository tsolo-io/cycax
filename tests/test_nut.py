...
def test_nut(tmp_path):
    ...
    hex_code_check(path=nut_loc, filename="testing_nut", ext=".json", hex_code = "22144e25a8dc044b89e4f5795ace224f90a87ae087647de05edb674daab09d93")
     

    hex_code_check(path=nut_loc, filename="testing_nut", ext=".scad", hex_code= "a2d137c720a5f204749757c5e6a2eacd003244c8642d55b85efd36db7e165815")
    

    hex_code_check(path=nut_loc, filename="testing_nut", ext=".stl", hex_code = "fdf00b4b0a62fbb105624bda0a7e3c870010f367515d7f7c6397c677a12fae86")
