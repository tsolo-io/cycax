...
def test_dynamic():
        ...
        assert box.export() == {'name': 'box', 'parts': [{'part_no': 'top', 'moves': [0, 0, 0], 'rotate': [], 'rotmax': [100, 100, 2], 'colour': 'grey'}, {'part_no': 'side', 'moves': [-2, -2, 0], 'rotate': [1], 'rotmax': [100, 104, 2], 'colour': 'grey'}, {'part_no': 'side', 'moves': [100, -2, 0], 'rotate': [1], 'rotmax': [100, 104, 2], 'colour': 'grey'}, {'part_no': 'front', 'moves': [0, -2, 0], 'rotate': [0], 'rotmax': [100, 100, 2], 'colour': 'grey'}, {'part_no': 'front', 'moves': [0, 100, 0], 'rotate': [0], 'rotmax': [100, 100, 2], 'colour': 'grey'}, {'part_no': 'top', 'moves': [0, 0, 98], 'rotate': [], 'rotmax': [100, 100, 2], 'colour': 'grey'}, {'part_no': 'con_cube', 'moves': [89, 0, 2], 'rotate': [2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [89, 0, 87], 'rotate': [2, 1, 1, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [89, 89, 2], 'rotate': [2, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [0, 0, 87], 'rotate': [2, 2, 1, 1, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [0, 89, 2], 'rotate': [2, 2, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [0, 89, 87], 'rotate': [2, 2, 2, 1, 1, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [0, 0, 2], 'rotate': [2, 2, 2, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}, {'part_no': 'con_cube', 'moves': [89, 89, 87], 'rotate': [2, 2, 2, 2, 1, 1, 2], 'rotmax': [11, 11, 11], 'colour': 'red'}]}
