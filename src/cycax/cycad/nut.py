...
def cut_hex(feature):
        ...
        hex2=Part.makePolygon(calc_hex(depth=6, diameter=2))
        nut=Part.makeRuledSurface(hex, hex2)
        ...
        return Part.makeSolid(nut.removeSplitter())
...
for data in definition["parts"]:
    if data:
        if FreeCAD.ActiveDocument:
            pass #FreeCAD.closeDocument(name)
