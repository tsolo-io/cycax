...
class Engine:
    ...
    def decode_cube(self, lookup: dict):
    ...
    def decode_external(self, data_file: str):
        return 'import("../parts_stl/' + data_file + '.stl");'

    def decode_hole(self, lookup: dict):
    ...
    def decode_nut(self, lookup: dict):
    ...
    def translate(self, lookup: dict):
